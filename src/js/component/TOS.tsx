...
const TOS = () => {
  return <div className="content">
    ...
    <p>Version 1.0</p>
    <p>The my-handicapped-pet.io website located at
      https://my-handicapped-pet.io is a copyrighted work belonging to
      my-handicapped-pet.io. Certain features of the Site may be subject to
    ...
    <p>These Terms of Use described the legally binding terms and conditions
      ...
      PROVISION OF THESE TERMS, DO NOT LOG INTO AND/OR USE THE SITE.</p><p>
  </p><p>These terms require the use of arbitration Section 10.2 on an
    individual basis to resolve disputes and also limit the remedies available
    to you in the event of a dispute. These Terms of Use were created with the
    help of the <a href="https://www.termsofusegenerator.net">Terms Of Use
      Generator</a>.</p>
    <h2>Access to the Site</h2>
    <p><strong>Subject to these Terms.</strong> Company grants you a
      non-transferable, non-exclusive, revocable, limited license to access the
      Site solely for your own personal, noncommercial use.</p>
    <p><strong>Certain Restrictions.</strong> The rights approved to you in
      ...
      copyright and other proprietary notices on the Site must be retained on
      all copies thereof.</p>
    ...
    <p><strong>No Support or Maintenance.</strong> You agree that Company will
    ...
    <h2>User Content</h2>
    <p><strong>User Content.</strong> "User Content" means any and all
    ...
    <p>You hereby grant to Company an irreversible, nonexclusive, royalty-free
      ...
      your User Content in the Site.&nbsp; You hereby irreversibly waive any
      claims and assertions of moral rights or attribution with respect to your
      User Content.</p>
    <p><strong>Acceptable Use Policy.</strong> The following terms constitute
      ...
      individual; (iii) that is harmful to minors in any way; or (iv) that is in
      violation of any law, regulation, or obligations or restrictions imposed
      by any third party.</p>
    <p>In addition, you agree not to: (i) upload, transmit, or distribute to or
      ...
      to generate automated searches, requests, or queries to the Site.</p>
    <p>We reserve the right to review any User Content, and to investigate
      ...
      authorities.</p>
    <p>If you provide Company with any feedback or suggestions regarding the
      ...
      and related information in any manner it believes
      appropriate.&nbsp; Company will treat any Feedback you provide to Company
      as non-confidential and non-proprietary.</p>
    <p>You agree to indemnify and hold Company and its officers, employees, and
    ...
    <p><strong>Third-Party Links &amp; Ads.</strong> The Site may contain links
      ...
      practices.</p>
    <p><strong>Other Users.</strong> Each Site user is solely responsible for
    ...
    <p><strong>Cookies and Web Beacons.</strong> Like any other website,
      my-handicapped-pet.io uses ‘cookies'. These cookies are used to store
    ...
    <p>The site is provided on an "as-is" and "as available" basis, and company
      ...
      and our suppliers make not guarantee that the site will meet your
      ...
      in duration to ninety (90) days from the date of first use.</p>
    ...
    <p><strong>Term and Termination.</strong> Subject to this Section, these
    ...
    <p>These Terms are subject to occasional revision, and if we make any
      ...
      e-mail address that you have provided us is not valid our dispatch of the
      ...
      will be effective upon the earliest of thirty (30) calendar days following
      ...
      Site.&nbsp; Continued use of our Site following notice of such changes
      ...
      WAIVER.</p>
    <p><strong>Applicability of Arbitration Agreement.</strong> All claims and
      ...
      the Terms.</p>
    <p><strong>Notice Requirement and Informal Dispute
      Resolution.</strong> Before either party may seek arbitration, the party
      must first send to the other party a written Notice of Dispute describing
      ...
      award to which either party is entitled.</p>
    <p><strong>Arbitration Rules.</strong> Arbitration shall be initiated
      ...
      Provider shall govern all aspects of the arbitration except to the extent
      ...
      sought is Ten Thousand U.S. Dollars (US $10,000.00) or more, the right to
      a hearing will be determined by the Arbitration Rules.&nbsp; Any hearing
      ...
      Provider.</p>
    <p><strong>Additional Rules for Non-Appearance Based
      Arbitration.</strong> If non-appearance based arbitration is elected, the
      ...
      personal appearance by the parties or witnesses unless otherwise agreed by
      the parties.</p>
    <p><strong>Time Limits.</strong> If you or the Company pursues arbitration,
      ...
      for the pertinent claim.</p>
    <p><strong>Authority of Arbitrator.</strong> If arbitration is initiated,
    ...
    <p><strong>Waiver of Jury Trial.</strong> THE PARTIES HEREBY WAIVE THEIR
    ...
    <p><strong>Waiver of Class or Consolidated Actions.</strong> All claims and
      ...
      jointly or consolidated with those of any other customer or user.</p>
    <p><strong>Confidentiality.</strong> All aspects of the arbitration
      ...
      award, or to seek injunctive or equitable relief.</p>
    <p><strong>Severability.</strong> If any part or parts of this Arbitration
    ...
    <p><strong>Right to Waive.</strong> Any or all of the rights and limitations
      ...
      any other portion of this Arbitration Agreement.</p>
    <p><strong>Survival of Agreement.</strong> This Arbitration Agreement will
      survive the termination of your relationship with Company.</p>
    <p><strong>Small Claims Court.</strong> Nonetheless the foregoing, either
      you or the Company may bring an individual action in small claims court.
    </p>
    <p><strong>Emergency Equitable Relief.</strong> Anyhow the foregoing, either
      party may seek emergency equitable relief before a state or federal court
      in order to maintain the status quo pending arbitration.&nbsp; A request
      for interim measures shall not be deemed a waiver of any other rights or
      obligations under this Arbitration Agreement.</p>
    <p><strong>Claims Not Subject to Arbitration.</strong> Notwithstanding the
    ...
    <p>In any circumstances where the foregoing Arbitration Agreement permits
      ...
      the personal jurisdiction of the courts located within sg County,
    ...
    <p><strong>Electronic Communications.</strong> The communications between
      ...
      hard copy writing.</p>
    <p><strong>Entire Terms.</strong> These Terms constitute the entire
    ...
    <p><strong>Copyright/Trademark Information.</strong> Copyright ©. All rights
